...
CREATE TABLE IF NOT EXISTS master_data_indonesia_regencies (
    region_code VARCHAR(4) NOT NULL PRIMARY KEY,
    province_region_code VARCHAR(2) NOT NULL,
    name VARCHAR(32) NOT NULL
);

INSERT INTO master_data_indonesia_regencies(region_code,province_region_code,name) VALUES
...
-- +goose Down
-- +goose StatementBegin
DROP TABLE IF EXISTS master_data_indonesia_regencies;
-- +goose StatementEnd
